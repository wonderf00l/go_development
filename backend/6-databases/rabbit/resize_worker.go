...
/*
паттерн для того чтобы справляться с нагрузкой - очередь задач
причем очередь могут разворачиватсья именно на период высокой нагрузки, пототм сворачиваться
*/
